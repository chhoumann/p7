...
morekeywords={partial, var, value, get, set,nameof, IEnumerable, abstract, event, new, struct,
...
do, is, sizeof, while, T, Action,
double, lock, stackalloc,
else, long, static, Params, ParamsSource, Task, CodeRunnerClient, CodeRunnerQueueClient, Benchmark,
