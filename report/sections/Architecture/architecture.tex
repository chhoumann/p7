...
The backend component has several responsibilities including routing, page rendering, authentication, role based data access, modification, as well as communication between other components.
