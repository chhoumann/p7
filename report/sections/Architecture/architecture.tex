...
authentication -> role based access -> business logic -> database access





The backend component has several responsibilities including routing, authentication, role based data access and modification, as well as communication between other components. 
Authentication is implemented by, xxx.
By granting different users a role of either lecturer or student we are able to delegate different functionality across roles. ... describe different functionality
this component can access the database to persist changes made by different roles.
