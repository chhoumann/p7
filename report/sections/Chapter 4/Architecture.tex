...
The database component is implemented as a Postgres database which is a regular relational database. The entities and their relationships contained within the database is shown as an entity relationship diagram in figure \ref{fig:Database}.

Note that the dotted lines represent a partial participation and the full lines represent total participation.
