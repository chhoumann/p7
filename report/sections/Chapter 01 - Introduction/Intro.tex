...
CodeWars focuses on competitive programming, meaning users compete to solve problems in the fastest and most efficient way.
...
To examine the scalability of the solution essential parts of the platform have been stress-tested to ensure availability and reliability when performing under unexpectedly many users \todo{source saying that it ensures QoS and R}.
