...
The front-end component is responsible for the UI platform and must provide the users with the functionality described in the use-cases \todo{ref til use-cases}.
...
After each component has been implemented, its scalability has been tested and documented in section x \todo{ref til test section}.
...
- The component's scalability has been measured in Section X \todo{ref to test section}. As this result is not satisfactory, further measures to ensure the accessibility of the system have been considered. 
