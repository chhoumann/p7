...
One of the primary goals of this application is to give the lecturer a way to specify what constitutes a correct problem solution. In this chapter, we describe how actions perfomed on the user interface propagate events throughout the various components.
...
Once the user interface for the page is rendered, we fetch the problem, test, and previous submissions for the user.
