...
When a user visits a page on our website, we fetch the code template exercise from the backend in order to prevent flashing in the template after the page has loaded.
