\chapter{Frontend} \label{chap:Frontend}\todo{rename this section}
...
Currently, only Haskell is supported, but it is easily extensible to include other languages.
