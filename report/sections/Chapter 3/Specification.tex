...
% --- maybe include something more between
...
% \begin{itemize}
%     \item students should be able to retrieve exercises.
%     \item students should be able to submit exercise solutions.
%     \item students should be able to verify their solutions.
%     \item lecturers should be able to add tests for exercises.
%     \item lecturers should be able to  add exercises to an exercise session.
%     \item lecturers should be able to add exercise sessions.
%     \item lecturers should be able to add sessions to the curriculum.
%     \item A user should be able to log in to determine whether they are a student or lecturer.
...
%         - need a client server system, to update assignments and send them to students
