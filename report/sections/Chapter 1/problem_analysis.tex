...
\subsubsection*{screen sharing by AAU}
Currently AAU uses a room designed by \textit{Center for Digitally Supported Learning} (CDUL) to support interactive learning. 
The room is set up with a monitor at each table where a group will sit. The group can then share their screen to the monitor, and the leturer can then share their own screen or the screens of a group of students to the entire class if needed on the monitors. 
