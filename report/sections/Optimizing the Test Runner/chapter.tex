\chapter{Optimizing the Test Runner} \label{chap:OptimizingTestRunner}
...
\include{sections/Optimizing the Test Runner/queue-system.tex}
\include{sections/Optimizing the Test Runner/sweeping-system.tex}