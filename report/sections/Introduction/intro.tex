Most students attending the \textit{Programming Paradigms} course failed last semester\footnote{As can be seen in appendix \ref{chap:PP-intro}, figure \ref{fig:PP-slide-failure-rate}.}.
