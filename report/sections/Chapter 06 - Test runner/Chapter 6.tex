...
\todo{Move this to frontend section-or similar.}
...
Sequentially starting a new \texttt{runhaskell} process for each request was identified as a major bottleneck during testing, as described in chapter \todo{ref benchmarks}. \todo{Make a transition to the queue system chapter}

% Lægger op til at vi kan snakke om hvordan vi har gjort det Blazingly Fast (TM)
