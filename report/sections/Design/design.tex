...
\section{Wireframe for Solving Exercises} \todo{Writing and submitting solutions}
The wireframe in figure \ref{fig:wfExercise} shows the page intended for solving exercises. \todo{what is a wireframe}
% primary use cases
% solve exercises
\begin{figure}[H]
...
\section{Wireframe for Browsing} \todo{browsing the page}
...
\section{Wireframe for Creating an Exercise} \todo{creating exercises}
