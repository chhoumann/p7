...
The wireframe in figure \ref{fig:wfExercise} shows the page intended for solving exercises. The figures \ref{fig:wfExerciseInstructions} and \ref{fig:wfExerciseResult} show 
% primary use cases
% solve exercises
\begin{figure}[H]
