...
Before the test, the interviewers have to ensure that a test plan, tasks, and questions are ready, and that the equipment works.
...
The System Usability Scale (SUS) is a standardized set of usability questions that can be used to compare a user interface to user interfaces from other systems. It is important to note that the System Usability Scale does not provide insight into specific problems; instead, it provides an overall rating of the system from the user's point of view.
