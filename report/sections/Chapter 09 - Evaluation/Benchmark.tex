...
\todo{explain the parameterization and how this differs from the other parameterization. Mention that the client also polls. Also mention that the poll time is an additional parameterization.}
