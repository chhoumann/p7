...
The goal with the stress tests and benchmarks is fourfold: 
\begin{enumerate}
\item It helps us determine an upper limit of simultaneous users before response times renders the evaluation of student's submission too slow to be useful.
