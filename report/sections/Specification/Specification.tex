...
\begin{enumerate}
    ...
    A Student should be able to choose an exercise session and a specific exercise. The exercise description is then shown to the user.
...
The \textit{Must have} category from the MoSCoW analysis represents the minimal amount of features to satisfy the project goals. Throughout the report, we will refer to this as the \textit{minimal viable product} (MVP).
In the following chapter, we will describe the design of the system user interface, which is based on the MVP.
